...
namespace Monitor {
        ...
        IPgCommandView 
    {
        ...
        public Guid Catagory => _guidView;

        public IPgParent Parentage => _oSite.Host;

        public IPgParent Services  => Parentage.Services;

        public static readonly Guid _guidView = new Guid( "{85031D86-3A4F-4D5B-9A1C-FC2A08BE7947}" );
        ...
        protected class DocSlot :
            ...
            ITCSite
		{
			protected readonly ViewRealTerminal _oHost;

			public DocSlot( ViewRealTerminal oHost ) {
        ...
        public ViewRealTerminal( IPgViewSite oSite, TerminalDocument oDoc ) {
