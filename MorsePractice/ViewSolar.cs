...
namespace Play.MorsePractice {
		...
		IPgCommandView
    {
        ...
        protected MorseDoc Document { get; }

		public IPgParent Parentage => _oSiteView.Host;
		public IPgParent Services  => Parentage.Services;

        protected List<LayoutRect>      CacheList { get; }      = new List<LayoutRect>();
        protected LayoutStackHorizontal Layout2   { get; set; } = new LayoutStackHorizontal( 5 );
        ...
        public ViewSolar( IPgViewSite oSiteView, MorseDoc oDocMorse ) {
            Document     = oDocMorse ?? throw new ArgumentNullException( "Morse Doc on View Solar must not be null." );
			...
			ViewSolarVhf = new ImageViewSingle( new ViewSolarSlot(this), oDocMorse.SolarVhf );
			ViewSolarMap = new ImageViewSingle( new ViewSolarSlot(this), oDocMorse.SolarMap );
        }
        ...
        public bool InitNew() {
            ...
            Layout2.Add( new LayoutStackVertical( 5, 450, 1F ) { new LayoutImageView(ViewSolarMap, .5F ), new LayoutImageView(ViewSolarVhf, .5F) } );
            Layout2.Add( new LayoutRect( LayoutRect.CSS.None ) );
